...
export function BenchmarkPanel({
  ...
  return (
    <aside className="panel benchmark-panel" data-testid="slow-benchmark-panel" aria-labelledby="slow-benchmark-title">
      <div className="panel-header">
        <div>
          <p className="eyebrow">Slow benchmark</p>
          <h2 id="slow-benchmark-title">Runtime profile</h2>
        </div>
      ...
      <dl className="metric-grid" aria-label="Slow app render metrics">
        <div>
          <dt>Commits</dt>
